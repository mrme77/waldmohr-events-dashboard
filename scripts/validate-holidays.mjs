...
const file = new URL("../app/public/holidays.json", import.meta.url);

/**
 * Validates a complete holiday payload.
 *
...
/**
 * Validates one holiday event record.
 *
...
function validateEvent(event, index) {
  ...
  const errors = requireStrings(event, p, ["id", "title", "originalTitle", "date"]);
...
runMain(() => runValidation({ file, label: "Holiday", noun: "holidays", collectionKey: "events", validatePayload }));
